...
int hp,xp,stone,dirt,spines,gravel,flower,wood,iron;
int px,py,max,may,mbx,mby,mcx,mcy;
int apy,apx,sa,imr,armor,cm,mal,mbl,mcl,amby,ambx;
int seed,rnd;
int i,j;
...
int main()
{
	...
	scanf(" %c",&a);
	if (a == 's') {
		hp = 5,xp = 0,stone = 0,dirt = 0,spines = 0,gravel = 0,flower = 0,wood = 0,iron = 0;
		mal = 1,mbl = 1,mcl = 0;
		grw();
	}
	if (a == 'e') {
		hp = 999,xp = 999,stone = 999,dirt = 999,spines = 999,gravel = 999,flower = 999,wood = 999,iron = 999;
		mal = 0,mbl = 0,mcl = 0;
		egrw();
	}
	printf("\nImmortal?(y/n)");
